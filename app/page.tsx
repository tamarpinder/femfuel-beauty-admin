        ...
        <div className="lg:w-1/2 flex items-center justify-center p-8 lg:p-12">
          <div className="w-full max-w-md">
            ...
            <div className="mb-8 text-center">
              <div className="mb-6">
                <Image 
                  ...
                  width={165}
                  height={165}
                  className="w-[165px] h-[165px] mx-auto hover:scale-105 transition-transform duration-300"
                />
              </div>
              ...
              <p className="text-femfuel-medium">
                Accede a tu panel de administración profesional
              </p>
            </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-blue-700 mb-3">
                    ...
                    <br />
                    <strong>Contraseña:</strong> AdminLogin2025!
                  </p>
                  <Button
                    type="button"
                    variant="outline"
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <Button
                type="submit"
                className="w-full h-12 bg-femfuel-rose hover:bg-femfuel-rose/90 text-white"
                disabled={isLoading}
              >
